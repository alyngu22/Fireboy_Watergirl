...
public class FWPaneFinal extends Application {
    ...
    public void start(Stage firstStage) {
        ...
        pane.getChildren().addAll(forest, stair, fireboy, watergirl, new FWPaneFinal.hedgePane(550,725),new FWPaneFinal.hedgePane(0,groundY),new FWPaneFinal.hedgePane(150,groundY),new FWPaneFinal.hedgePane(300,groundY),
